...
public class RenderEntityEye {
    ...
    static private void renderLine(final double x1, final double y1, final double z1, final double x2, final double y2, final double z2) {
